...
const styles = StyleSheet.create({
  ...
  colTitle:    { width: "28%", paddingHorizontal: 6 },
  colCategory: { width: "18%", paddingHorizontal: 6 },
  colFormat:   { width: "14%", paddingHorizontal: 6 },
  colRentals:  { width: "16%", paddingHorizontal: 6, textAlign: "center" },
  colRevenue:  { width: "14%", paddingHorizontal: 6, textAlign: "center" },
...
export function LocationReport({ rightsholderName, periodStart, periodEnd, entries }: Props) {
  const rows = [...entries];
  while (rows.length < 10) {
    rows.push({ order: "", title: "", category: "", format: "", rentals: "", totalRevenue: "" });
  }
